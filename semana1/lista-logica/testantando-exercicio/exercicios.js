...
// const segundoNumero = Number(prompt("Escolha um outro número"))

// const resultado = primeiroNumero + segundoNumero
// const outroResultado = primeiroNumero * segundoNumero
// console.log(resultado, outroResultado)

// const filme = {
//     titulo: "Blue Valentine",
//     direcao: "Derek Cianfrance",
//     ano: 2010,
//     elenco: ["Ryan Gosling", "Michelle Williams"],
//     isVisto: true
// }

// console.log("Título:", fime.titulo)
// console.log("Direção:", filme.direcao)
// console.log("Ano de lançamento:", filme.ano)
// console.log("Elenco:" filme['elenco'])
// console.log("Já assisti: filme.['isVisto']")
...
const frase = `O nome da pessoa é ${pessoa.nome},
 ela tem ${pessoa.idade}, anos e gosta muito de ${pessoa.generoMusical}.`
 console.log(frase)
